...
public class CombatManager {
    ...
    private final Map<Player, CombatState> combatStates = new HashMap<>();
    private final Map<Player, BukkitRunnable> timersMap = new HashMap<>();
    ...
    public void enablePvP(Player player) {
        setPlayerCombatState(player, PvPState.ON);
    ...
    public void setPlayerCombatState(Player player, CombatState combatState) {
        combatStates.put(player, combatState);
    }
    ...
    public void disablePvP(Player player) {
        setPlayerCombatState(player, PvPState.OFF);
